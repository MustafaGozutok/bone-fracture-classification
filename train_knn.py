"""
Bone Fracture Classification - KNN (K-Nearest Neighbors)
=========================================================
Classical pipeline:
  - HOG + LBP + GLCM feature fusion + PCA
  - GridSearchCV for KNN hyperparameters
"""
...
def train_knn(X_train_pca, y_train, X_val_pca, y_val):
    ...
    print("[INFO] GridSearchCV starting (KNN)...")
    t0 = time.time()
...
def main():
    print("=" * 60)
    print("  KNN - Bone Fracture Classification")
    print("=" * 60)
    ...
    # 4. Train model
    model, best_params = train_knn(F_train_pca, y_train, F_val_pca, y_val)
